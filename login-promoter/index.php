...
<head>
    ...
    <link href="../login-promoter/css/style.css" rel="stylesheet">
    <title>Login do Promoter</title>
    <style>
        .msg-erro {
            margin-top: 20px;
            padding: 10px;
...
<body>
    ...
    <div class="h1-flex">
        <h1>Login | Promoter</h1>
    </div>
    
    <div class="box">
        <form action="login.php" method="post">
            <fieldset>
                <legend><b>Login do Promoter</b></legend>
                <br>
                <div class="inputBox">
            ...
            <div class="link">
            <p>Não possui conta: <a href="../cadastro-promoter/index.php"><bold>Cadastre-se</bold></a></p>
            </div>
        </form>
        <?php
