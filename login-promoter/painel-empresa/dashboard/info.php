...
?>
    <div class="catalogo_patrocinador">
        <div class="img_patrocinador">
            <img id="img_patrocinador" src="../cadastrar-evento/<?php echo $user_patrocinador['diretorio_img_patrocinador'];?>" alt="Imagem da atração do evento" title="Foto da atração">
        </div>

        <p class="infoPatrocinador">Nome: <?php echo $user_patrocinador['nm_patrocinador'] ?></p>
