...
?>
            <div class="item current-item">
                <div class="img_slide">
                    <img class="item_img current-item" src="/events4u/painel-empresa/cadastrar-evento/<?php echo $user_atracao['diretorio_img_atracao'] ?>" alt="" title="">
                </div>

                <p class="infoAtracao">Nome:<br> <?php echo $user_atracao['nome_atracao'] ?></p>
                <p class="infoAtracao">Data da apresentação:<br> <?php echo date("d/m/y", strtotime($user_atracao['dt_atracao'])) ?> </p>
                <p class="infoAtracao">Hora da apresentação:<br> <?php echo date("H:i", strtotime($user_atracao['hr_atracao']))?></p>
